...
public class ApiHandler
{
    ...
    private List<ElectricityPrice> MakePricesFromJson(string electricityPricesjson, Locations location)
    {
        // test json
        ...
        List<ElectricityPrice> electricityPrices = new List<ElectricityPrice>();

        if (!string.IsNullOrEmpty(electricityPricesjson) && !string.IsNullOrWhiteSpace(electricityPricesjson))
        {
            electricityPrices = JsonSerializer.Deserialize<List<ElectricityPrice>>(electricityPricesjson);
    ...
    private List<ElectricityPrice> GetPricesBasedOnLocation(Locations location)
    {
    ...
    public List<ElectricityPrice> GetWestPrices()
    {
        return GetPricesBasedOnLocation(Locations.WestDenmark);
    }

    public List<ElectricityPrice> GetEastPrices()
    {
